  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="grid gap-2 sm:grid-cols-3">
        ...
        <div className="rounded-lg bg-emerald-500/10 p-3"><span className="text-xs text-muted-foreground">Honorários mensais</span><strong className="block font-mono text-lg text-emerald-400">{formatBRLCurrency(total.toFixed(2))}</strong></div>
