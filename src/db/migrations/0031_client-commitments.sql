...
-- O indice unico precisa existir ANTES da FK composta que o referencia:
-- o Postgres exige unicidade em (org_id, id) para aceitar a FK, e o
-- drizzle-kit gera os CREATE INDEX depois dos ADD CONSTRAINT.
